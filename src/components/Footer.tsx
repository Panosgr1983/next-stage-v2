        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-slate-400 hover:text-[#6ab04c] transition-colors duration-200">
                  {t('nav.home')}
                </a>
              </li>
              <li>
                <a href="#services" className="text-slate-400 hover:text-[#6ab04c] transition-colors duration-200">
                  {t('nav.services')}
                </a>
              </li>
              <li>
                <a href="#about" className="text-slate-400 hover:text-[#6ab04c] transition-colors duration-200">
                  {t('nav.about')}
                </a>
              </li>
              <li>
                <a href="#gallery" className="text-slate-400 hover:text-[#6ab04c] transition-colors duration-200">
                  {t('nav.gallery')}
                </a>
              </li>
              <li>
                <a href="#contact" className="text-slate-400 hover:text-[#6ab04c] transition-colors duration-200">
                  {t('nav.contact')}
                </a>
              </li>
            </ul>
